...
#else
static const char *fonts[]               = { "JetBrains Mono:size=8:antialias=true:autohint=true" };
#endif // BAR_PANGO_PATCH
static const char dmenufont[]            = "JetBrains Mono:size=8:antialias=true:autohint=true";
